...
public class CustomerCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeNavi.setOnClickListener(v -> startActivity(new Intent(CustomerCartActivity.this, CustomerHomeActivity.class)));
        favoriteNavi.setOnClickListener(v -> startActivity(new Intent(CustomerCartActivity.this, CustomerFavoriteActivity.class)));
        ColorStateList colorStateList = ContextCompat.getColorStateList(getApplicationContext(), R.color.my_primary);
        cartNavi.setColorFilter(colorStateList.getDefaultColor(), PorterDuff.Mode.SRC_IN);
        categoryNavi.setOnClickListener(v -> startActivity(new Intent(CustomerCartActivity.this, CustomerCategoryActivity.class)));
        profileNavi.setOnClickListener(v -> startActivity(new Intent(CustomerCartActivity.this, CustomerProfileActivity.class)));
    }
}
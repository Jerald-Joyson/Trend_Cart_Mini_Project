...
public class CustomerProfileEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeNavi.setOnClickListener(v -> startActivity(new Intent(CustomerProfileEditActivity.this, CustomerHomeActivity.class)));
        favoriteNavi.setOnClickListener(v -> startActivity(new Intent(CustomerProfileEditActivity.this, CustomerFavoriteActivity.class)));
        categoryNavi.setOnClickListener(v -> startActivity(new Intent(CustomerProfileEditActivity.this, CustomerCategoryActivity.class)));
        cartNavi.setOnClickListener(v -> startActivity(new Intent(CustomerProfileEditActivity.this, CustomerCartActivity.class)));
